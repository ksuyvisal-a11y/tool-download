...
class AdminUpdateManagerApp:
    ...
    def _build_ui(self):
        ...
        tk.Label(f_ver, text="New Release Version (e.g. 1.1.2):", font=("Segoe UI", 9, "bold"), fg="#E2E8F0", bg="#070B16").pack(anchor="w")
        ...
        self.ent_version.insert(0, "1.1.2")
    ...
    def _load_current_feed(self):
        if os.path.exists(UPDATE_JSON_PATH):
            try:
                ...
                self.ent_version.insert(0, data.get("version", "1.1.2"))
