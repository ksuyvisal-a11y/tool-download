...
python -m nuitka --standalone --windows-console-mode=disable --windows-icon-from-ico=assets/app_icon.ico --include-data-dir=assets=assets --include-data-dir=ui=ui --include-package=webview --include-package=customtkinter --include-package=yt_dlp --include-package=imageio_ffmpeg --include-module=security_guard --include-module=licensing --include-module=downloader --include-module=converter --include-module=scheduler --include-module=updater --include-module=utils --python-flag=no_docstrings --lto=yes --output-dir=dist_native app.py
